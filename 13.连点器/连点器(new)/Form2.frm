...
'TranscribeResultData   录制数据  类型：MousebuttonData
Dim Transcribe As MouseButtonData
...
GetName:
                ...
                If PublicMethod.NameRepeatCheck(FileName, Form1.ProjectDispose.KeyList(, "MouseTranscribe"), ",") Then MsgBox "鼠标录制名称重复！", 48: GoTo GetName
...
GetComment:
        ...
        Case LCase(Form1.TranscribePause_Text.Text)
            ...
            If Not PublicMethod.NameRepeatCheck(FileName & ".MDS", Form1.ProjectDispose.KeyList(, "MouseTranscribe"), ",") Then
...
Private Sub Form_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If WriteFlag Then
        ...
        '调用 SetMouse模块 的 API GetCursorPos 记录 鼠标的 X、Y坐标 和 按键
