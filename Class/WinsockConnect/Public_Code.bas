...
Static Function RePort(Equipment As Winsock, Array_Bool As Boolean, Clear_Bool As Boolean,optional Count As Integer = 1) As String
...
RePortData = RePortData & Port(i) & String(9 - Len(Str(Port(i))), " ") & State(i) & Chr(10)
